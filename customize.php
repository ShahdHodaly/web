...
<head>
    ...
    <style>
        ...
        /* طبقات عرض البطاقات في المعرض */
        .gallery-card-preview .preview-base {
            width: 100%;
            height: 100%;
            object-fit: contain;
            z-index: 1;
        ...
        .gallery-card-preview .preview-outfit {
            width: 70%;
            top: 45%;
            left: 50%;
        ...
        /* تعديلات خاصة بالأحذية */
        .gallery-card-preview .preview-shoes {
            width: 60%;
            top: 85%;
            left: 48%;
            transform: translate(-50%, -50%);
        ...
        /* الإكسسوار في المعرض */
        .gallery-card-preview .preview-acc {
            width: 26%;
            top: 18%;
            left: 15%;
            transform: translate(-50%, -50%);
...
<div class="lab-container">
    ...
    <div class="lab-grid">
        ...
        <div class="widget-col pos-acc">
            ...
            <div class="creative-box acc-box">
                ...
                <div class="item-display">
                    ...
                    <div class="item-card" onclick="toggleSelection('acc', 'images/redacc.png', this, 'Red Accessory')">
                        <img src="images/redacc.png" alt="Acc 1">
                    </div>
                    <div class="item-card" onclick="toggleSelection('acc', 'images/ball.png', this, 'Ball')">
                        <img src="images/ball.png" alt="Acc 2">
                    </div>
                    <div class="item-card" onclick="toggleSelection('acc', 'images/sunglasses.png', this, 'Sunglasses')">
                        <img src="images/sunglasses.png" alt="Acc 3">
                    </div>
                    <div class="item-card" onclick="toggleSelection('acc', 'images/camera.png', this, 'Camera')">
                        <img src="images/camera.png" alt="Acc 4">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="widget-col pos-color">
            ...
            <div class="color-palette-box">
                <div class="paint-drop d1"></div>
                <div class="paint-drop d2"></div>
                <div class="paint-drop d3"></div>
                <div class="paint-drop d4"></div>
        ...
        <div class="widget-col pos-outfit">
            ...
            <div class="creative-box outfit-box">
                ...
                <div class="item-display">
                    <div class="stand-bar"></div>
                    <div class="item-card" onclick="toggleSelection('outfit', 'images/reddress.png', this, 'Red Dress')">
                        <img src="images/reddress.png" alt="Outfit 1">
                    </div>
                    <div class="item-card" onclick="toggleSelection('outfit', 'images/pinkoutfit.png', this, 'Pink Outfit')">
                        <img src="images/pinkoutfit.png" alt="Outfit 2">
                    </div>
                    <div class="item-card" onclick="toggleSelection('outfit', 'images/greenoutfit.png', this, 'Casual Outfit')">
                        <img src="images/greenoutfit.png" alt="Outfit 3">
                    </div>
                    <div class="item-card" onclick="toggleSelection('outfit', 'images/jeansoutfit.png', this, 'Jeans Outfit')">
                        <img src="images/jeansoutfit.png" alt="Outfit 4">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="widget-col pos-name">
            ...
            <div class="name-craft-box">
                ...
                <button class="craft-btn" onclick="saveName()">
        ...
        <div class="widget-col pos-shoes">
            ...
            <div class="creative-box shoes-box">
                ...
                <div class="item-display">
                    <div class="stand-bar"></div>
                    <div class="item-card shoe-item" onclick="toggleSelection('shoes', 'images/redshoes.png', this, 'Red Shoes')">
                        <img src="images/redshoes.png" alt="Shoes 1">
                    </div>
                    <div class="item-card shoe-item" onclick="toggleSelection('shoes', 'images/darkshoes.png', this, 'Boots')">
                        <img src="images/darkshoes.png" alt="Shoes 2">
                    </div>
                    <div class="item-card shoe-item" onclick="toggleSelection('shoes', 'images/pinkshoes.png', this, 'Pink Shoes')">
                        <img src="images/pinkshoes.png" alt="Shoes 3">
                    </div>
                    <div class="item-card shoe-item" onclick="toggleSelection('shoes', 'images/conversshoes.png', this, 'Convers shoes')">
                        <img src="images/conversshoes.png" alt="Shoes 4">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="sound-device">
                    ...
                    <div class="device-controls" id="controlsInitial">
                        <button class="btn-rec" id="btnRec" onclick="toggleRecording()">
                            <i class="fa-solid fa-microphone" id="recIcon"></i>
                        </button>
                    </div>

                    <div class="device-controls" id="controlsRecorded" style="display:none;">
                        <button class="btn-action visible" onclick="deleteRecording()" title="Delete">
                            <i class="fa-solid fa-trash"></i>
                        </button>
                        <button class="btn-rec" onclick="playPauseAudio()" style="width:35px; height:35px;">
                            <i class="fa-solid fa-play" id="playIcon"></i>
                        </button>
                        <button class="btn-action visible heart-btn" onclick="saveRecording()" title="Save">
                            <i class="fa-solid fa-heart"></i>
                        </button>
                    </div>
                    ...
                    <div class="saved-ui" id="savedUI">
                        ...
                        <div class="status-row">
                            ...
                            <button class="btn-reset" onclick="resetRecorder()" title="Record New">
    ...
    <!-- قسم المعرض والتصاميم المقترحة -->
    <div class="gallery-section">
        <p class="section-subtitle">Top Suggestions</p>
        <div class="gallery-grid" id="suggestionsGrid">
            <!-- Populated by JS -->
        </div>
    </div>
...
<script>
    // إعدادات الأسعار وحالة التطبيق
    const prices = { base: 20, outfit: 5, shoes: 3, acc: 4, sound: 5 };

    // ربط أسماء الألوان بالملفات
    const colorFiles = {
        'brown': 'brown.png',
        'white': 'white.png',
        'black': 'black.png',
    ...
    function toggleSelection(type, imgSrc, element, itemName) {
        ...
        if (parentDisplay) {
            parentDisplay.querySelectorAll('.item-card').forEach(c => c.classList.remove('selected'));
        }
    ...
    // ===== تعديل مهم: حفظ بيانات الصوت =====
    function saveRecording() {
        if (!recordedAudioBase64) {
            alert("No audio recorded yet.");
            return;
        }
        // نقوم بحفظ بيانات الصوت (Base64) مباشرة داخل التكوين
    ...
    function resetRecorder() {
        recordedBlob = null; recordedAudioBase64 = null; audioPlayback.src = ""; currentConfig.sound = null; soundIndicator.classList.remove('active');
        savedUI.classList.remove('visible'); controlsRecorded.style.display = 'none'; controlsInitial.style.display = 'flex';
        screenStatus.innerText = ""; playIcon.className = 'fa-solid fa-play';
    }

    // منطق تحديث ملخص الطلب
    ...
    // توليد بيانات التصميم
    function generateDesignData() {
        let desc = [];
        desc.push(`Color: ${currentConfig.color.name}`);
    ...
    function addToCart(btn) {
        ...
        // 2. Save temporary details for cart display
    ...
    function saveDesign(btn) {
        ...
        // Save to My Teddies (saved designs)
    ...
    function generateCardHTML(config, title) {
        ...
        // استخراج أسماء الملفات لإضافتها ككلاسات
        let outfitClass = '';
        if (config.outfit) {
            const outfitFile = config.outfit.img.split('/').pop().split('.').shift();
            outfitClass = `preview-outfit img-${outfitFile}`;
        }
        let shoesClass = '';
        if (config.shoes) {
            const shoesFile = config.shoes.img.split('/').pop().split('.').shift();
            shoesClass = `preview-shoes img-${shoesFile}`;
        }
        let accClass = '';
        if (config.acc) {
            const accFile = config.acc.img.split('/').pop().split('.').shift();
            accClass = `preview-acc img-${accFile}`;
        }

        // ترميز الكائن لاستخدامه في زر Use
        ...
        <div class="gallery-card">
            ...
            <div class="gallery-card-info">
                ...
                <button class="use-btn" onclick="event.stopPropagation(); applyPreset(decodeURIComponent('${configStr}'))" title="Apply">
                    Use
                </button>
            </div>
        </div>
    ...
    function loadGallery() {
        ...
        // تحويل التصميمات المحفوظة إلى صيغة مشابهة للاقتراحات
        const savedItems = savedDesigns.map(d => ({
            title: d.name,
            color: d.config.color,
            outfit: d.config.outfit,
            shoes: d.config.shoes,
            acc: d.config.acc
        }));

        // دمج الكل
        const allItems = [...suggestions, ...savedItems];

        suggestionsGrid.innerHTML = allItems.map(item => {
            const configStr = encodeURIComponent(JSON.stringify(item));
            return generateCardHTML(item, item.title, `applyPreset(decodeURIComponent('${configStr}'))`);
        }).join('');
    }

    // تطبيق التصميم المختار
    function applyPreset(configStr) {
        const preset = JSON.parse(decodeURIComponent(configStr));
        resetDesign(false); // Clear first
    ...
    function applySavedDesign(id) {
        ...
        if(design && design.config) {
            ...
            selectColor(null, c.color.name.toLowerCase());
            if(c.outfit) toggleSelection('outfit', c.outfit.img, null, c.outfit.name);
            if(c.shoes) toggleSelection('shoes', c.shoes.img, null, c.shoes.name);
            if(c.acc) toggleSelection('acc', c.acc.img, null, c.acc.name);
    ...
    function surpriseMe() {
        ...
        const randomConfig = {
            color: { name: rand(colors) },
            outfit: { img: rand(outfits) },
            shoes: { img: rand(shoes) },
            acc: { img: rand(accs) }
        };

        applyPreset(encodeURIComponent(JSON.stringify(randomConfig)));
    }
