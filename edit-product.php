...
<div class="admin-wrapper">
    ...
    <main class="admin-main">
        <div class="form-container">
            ...
            <!-- Product Form -->
            <form action="edit-product.php?id=<?= $product_id ?>" method="POST" enctype="multipart/form-data" id="productForm">
                <div class="form-layout">
                    ...
                    <div class="image-section">
                        ...
                        <p style="font-size: 11px; color: var(--secondary-text); margin-top: 10px;">Leave empty to keep current image</p>
                    </div>
                </div>
                ...
                <div class="form-buttons">
                    ...
                    <a href="product_details-admin.php?id=<?= $product_id ?>" class="btn-cancel">
