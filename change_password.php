...
<head>
    ...
    <style>
        ...
        .change-pass-container { padding: 120px 20px 50px; max-width: 500px; margin: 0 auto; }
        .form-card { background: var(--card-bg); border-radius: 25px; padding: 40px; box-shadow: 0 15px 40px var(--shadow); position: relative; overflow: hidden; }
        .back-link { display: inline-flex; align-items: center; gap: 8px; color: var(--secondary-text); text-decoration: none; margin-bottom: 25px; font-weight: 500; transition: color 0.3s; }
        .back-link:hover { color: var(--pink); }
        .form-title { font-family: 'Playfair Display', serif; font-size: 28px; color: var(--text-color); text-align: center; margin-bottom: 10px; }
        .form-subtitle { text-align: center; color: var(--secondary-text); font-size: 14px; margin-bottom: 30px; }
        .form-group { margin-bottom: 20px; }
        .form-group label { display: block; margin-bottom: 8px; font-size: 14px; color: var(--text-color); font-weight: 500; }
        .input-wrapper { position: relative; }
        .input-wrapper i { position: absolute; left: 15px; top: 50%; transform: translateY(-50%); color: #ccc; }
        .form-input { width: 100%; padding: 12px 15px 12px 45px; border: 2px solid #eee; border-radius: 15px; font-family: 'Poppins', sans-serif; font-size: 15px; color: var(--text-color); background: var(--bg-color); transition: border-color 0.3s; box-sizing: border-box; }
        .form-input:focus { outline: none; border-color: var(--pink); }
        .submit-btn { width: 100%; padding: 14px; background: linear-gradient(45deg, #ff9a9e, #fad0c4); color: #fff; border: none; border-radius: 50px; font-weight: bold; font-size: 16px; cursor: pointer; transition: transform 0.3s, box-shadow 0.3s; margin-top: 10px; }
        ...
        <form method="POST" action="">
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="password" name="current_pass" class="form-input"
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="password" name="new_pass" class="form-input"
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="password" name="confirm_pass" class="form-input"
